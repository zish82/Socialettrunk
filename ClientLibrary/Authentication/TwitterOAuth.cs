    ...
    public class TwitterOAuth : OpenAuthenticate
    {
        ...
        public override async Task<OpenAuthenticationResult> Authenticate()
        {
            try
            {
                ...
                var getResponse = await oAuth.SendDataAsync(requestTokenUrl);
        ...
        public override void Post(string status)
        {
            ...
            Task<TwitterPostResults> result = PostData(resourceUrl, authHeader, postBody);
        }
        ...
        private async Task<TwitterPostResults> PostData(String url, String headers, String requestData = null)
        {
            try
            {
                ...
                {
                    using (var requestDataStream = new StreamWriter(await request.GetRequestStreamAsync()))
                    {
